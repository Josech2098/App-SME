  ...
  useEffect(() => {
    try {
      ...
      const dfNorm = dfComm.map(item => {
        ...
        // Ponderación exacta actualizada: 46.50% CTCO, 25.00% IEMP, 28.50% IOEF
    ...
    <div className="space-y-6 text-slate-100 font-sans p-2">
      <div className="border-b border-slate-800 pb-3">
        ...
        <p className="text-xs text-slate-400 mt-1">
          Cruce y normalización ponderada (46.50% Aranceles, 25.00% Penetración, 28.50% Libertad Económica).
        </p>
      </div>
